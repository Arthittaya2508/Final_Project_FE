...
import DressStyle from "../guest/components/homepage/DressStyle";
import Header from "../guest/components/homepage/Header";
    ...
    <>
      ...
      <main className="my-[50px] sm:my-[72px]">
        <ProductListSec
          ...
          viewAllLink="/guest/shop#new-arrivals"
        />
        ...
        <div className="mb-[50px] sm:mb-20">
          <ProductListSec
            title="สินค้าขายดี"
            data={topSellingData}
            viewAllLink="/guest/shop#top-selling"
          />
        </div>
        <div className="mb-[50px] sm:mb-20">
          <DressStyle />
