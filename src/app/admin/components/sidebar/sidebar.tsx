    ...
    <ul className="mb-10 px-4 w-full">
      {menuItems
        ...
        .map((item, index) => (
          <li key={index}>
            <Link legacyBehavior href={item.href}>
              <a className="relative flex h-11 flex-row items-center border-transparent text-black hover:rounded hover:bg-primary-200 hover:text-primary-900 focus:outline-none w-full">
                <span className="inline-flex items-center justify-center pl-2 pr-4 text-xl">
                  {item.icon}
                </span>
                <span className="text-md truncate tracking-wide">
